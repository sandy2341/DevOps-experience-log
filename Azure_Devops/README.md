...
##  7: Deploying an application behind Firewall on Azure - (PROJECT 1)
...
##  8: Azure Interview Questions (Compute and Networking)
- Interview Questions on the topics covered till  6
- Cloud computing concepts
- Azure Basics
- Azure Networking

##  9: Azure Storage Services
- Types of Azure Storage Services
- Use Cases

##  10: Command Line Interface for Azure
- Azure CLI Deep Dive
...
##  15: Azure DevOps - CD Setup - (PROJECT 3)
...
##  16: Azure Kubernetes Services(AKS Deep Dive) 
- AKS Deep Dive
- Understanding AKS vs Self managed Kubernetes clusters

##  17: Deploying a Three Tier architecture E-commerce (8 Services, 2 Databases) on AKS - (PROJECT 4)
...
##  18: Azure DevOps Interview Questions
- Beginner level Azure DevOps Interview Q&A
- Advanced level Azure DevOps Interview Q&A

##  19: Azure Cloud Watch(Monitor) and Monitoring Services
- Monitoring Overview
...
##  22: Event Driven Serverless - (PROJECT 5)
- Create Azure Functions that are triggered by Azure Blob creation

##  23: Manage Azure Resources using Terraform - (PROJECT 7)
